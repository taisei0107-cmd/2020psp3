...
## ソースコードの説明
76～80行目　表を初期化(nap_value[][]をすべて0)

82～98行目　商品一つずつについて、ナップサックの容量の少ないところから順番に、以下の処理を繰り返す

83～86行目　商品が入らない場合は上の状態を引き継ぐ

88～97行目　商品が入る部分については、商品を入れ替えない場合の価値と商品を入れ替えた場合の価値ij2つを比較し、最適な方を選択
